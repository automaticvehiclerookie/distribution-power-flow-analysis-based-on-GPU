...
const baseMVA = 100.0
@variables θn_ac2,Vn_ac2,Vn_dc1,Vn_dc2,θn_f,Vn_f,M,θn_c,Vn_c
@parameters Vn_ac1,θn_ac1
...
parameters=[Vn_ac1,θn_ac1,G11,B11,G12,B12,G21,B21,G22,B22,Pac2,Qac2,Pdc1,Pdc2,Gdc11,Gdc12,Gdc21,Gdc22,eta,Gtf,Btf,bf,Ps,Bc,Gc,Qs,a,b,c]
@mtkbuild ns = NonlinearSystem(eqs, [θn_ac2,Vn_ac2,Vn_dc1,Vn_dc2,θn_f,Vn_f,M,θn_c,Vn_c], parameters)
u0=[
    θn_ac2 => 0.0,
    Vn_ac2 => 1.0,
    Vn_dc1 => 1.0,
