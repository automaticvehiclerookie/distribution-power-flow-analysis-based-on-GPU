function case7h()
 ...
 # fbusdc  tbusdc  r      l    c   rateA   rateB   rateC   status
  ...
  # busdc_i busac_i P_g   Q_g   Vtar    rtf     xtf     bf     rc     xc     basekVac    Vmmax   Vmmin   Imax    status   LossA LossB  LossCrec LossCinv 
    mpc["converter"]=[
        1   2   -60 -40 1   0.0015  0.1121  0.0887  0.0001  0.16428 345 1.1 0.9 1.2 1   0.0001 0.0  0.0    4.371;
        2   3   0   0   1   0.0015  0.1121  0.0887  0.0001  0.16428 345 1.1 0.9 1.2 1   0.0001 0.0 0.0    4.371;
    ]
    return mpc
end